...
const { createBooking,verifyPayment,userAlreadyRegisterOrNot, userAttend } = require("../controllers/booking.controller.js");
...
router.route("/userAttend/:eventId").patch(verifyJwt,userAttend);
